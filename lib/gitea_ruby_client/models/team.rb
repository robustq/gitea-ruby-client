...
module GiteaRubyClient
  ...
  class Team
    attr_accessor :can_create_org_repo

    attr_accessor :description

    attr_accessor :id

    attr_accessor :includes_all_repositories
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GiteaRubyClient::Team` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GiteaRubyClient::Team`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      permission_validator = EnumAttributeValidator.new('String', ["none", "read", "write", "admin", "owner"])
    ...
    def permission=(permission)
      validator = EnumAttributeValidator.new('String', ["none", "read", "write", "admin", "owner"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          can_create_org_repo == o.can_create_org_repo &&
          description == o.description &&
          id == o.id &&
          includes_all_repositories == o.includes_all_repositories &&
          name == o.name &&
          organization == o.organization &&
          permission == o.permission &&
          units == o.units &&
          units_map == o.units_map
    end
    ...
    def hash
      [can_create_org_repo, description, id, includes_all_repositories, name, organization, permission, units, units_map].hash
    end
