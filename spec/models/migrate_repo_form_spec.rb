...
# Unit tests for GiteaRubyClient::MigrateRepoForm
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GiteaRubyClient::MigrateRepoForm do
  let(:instance) { GiteaRubyClient::MigrateRepoForm.new }

  describe 'test an instance of MigrateRepoForm' do
    it 'should create an instance of MigrateRepoForm' do
      expect(instance).to be_instance_of(GiteaRubyClient::MigrateRepoForm)
    end
  end
